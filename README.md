...
```
docker build --tag ghcr.io/ponywka/apple-music-wrapper:local .
```

2. Login:

```
docker run --privileged --rm -it -v ./rootfs/data:/app/rootfs/data --entrypoint ./wrapper ghcr.io/ponywka/apple-music-wrapper:local -L "username:password" -H 0.0.0.0
```
...
```
docker run --privileged -v ./rootfs/data:/app/rootfs/data -p 10020:10020 -p 20020:20020 -p 30020:30020 -e args="-H 0.0.0.0" ghcr.io/ponywka/apple-music-wrapper:local
```
